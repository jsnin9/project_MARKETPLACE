...
public class Main {
	...
	public static void main(String[] args) throws NosExceptions {
		...
		//VENDEUR
		 ...
		 //int p = Vendeur.sidentifier("gis.com", "zik74x");  /*cette ligne ne doit pas être cachée pour la suite*/
		 //System.out.println(p);   /*on affiche bien 1 qui est l'indice du deuxième vendeur*/
		...
		// Vendeur.getVendeur(p).seConnecter();  /*connexion, la ligne doit rester ouverte*/
		 ...
		 int q = Client.sidentifier("sharon7","asz4gl");  /*cette ligne ne doit pas être cachée pour la suite*/
		 //System.out.println(q);   /*on affiche bien 1 qui est l'indice du deuxième vendeur*/
